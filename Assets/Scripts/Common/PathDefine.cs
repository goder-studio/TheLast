...
{
    public const string AutomaticRifleIcon = "Sprites/AutomaticRifleIcon";
    public const string HandGunIcon = "Sprites/HandGunIcon";
    public const string checkSprite = "Sprites/check";
    public const string checknotSprite = "Sprites/checknot";
